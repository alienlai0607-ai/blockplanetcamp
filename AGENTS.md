...
- 音效：比賽畫面可試聽並選擇 4 首一般賽事音樂與 3 首最後 30 秒音樂（全部 CC0）；預設「Boss Fight Bounce／星球彈跳」搭配「Final Stand Max／最終決戰 MAX」。最後 30 秒自動以 1.08× 播放並疊加 Web Audio 重鼓、心跳、急促琶音與最後 10 秒警示；來源與授權記錄在 `drone-soccer/AUDIO-CREDITS.md`
